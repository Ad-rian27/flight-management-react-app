    ...
    return (
        <div>
            ...
            <div className="container mt-5 pt-5">
                <h2 className="mb-4 text-center">Add New Flight</h2>
                ...
                <div className="row g-3">
                    ...
                    <div className="col-md-6">
                        ...
                        <input type="number" className="form-control" name="fare" value={input.fare} onChange={inputHandler} />
                    </div>
                    <div className="col-md-6">
                        <label className="form-label">Total Seats</label>
                        <input type="number" className="form-control" name="total_seats" value={input.total_seats} onChange={inputHandler} />
                    </div>
                    <div className="col-md-6">
                        <label className="form-label">Available Seats</label>
                        <input type="number" className="form-control" name="available_seats" value={input.available_seats} onChange={inputHandler} />
                    </div>
                    <div className="col-md-6">
                    ...
                    <div className="col-12 mt-4">
                        <button className="btn btn-primary w-100" onClick={readValues}>Submit</button>
                    </div>
                </div>
            </div>
        </div>
